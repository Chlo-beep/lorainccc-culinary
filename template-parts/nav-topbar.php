<div class="column row no-js">
	...
	<div class="top-bar">
		...
		<div class="top-bar-title">
			...
			<a href="<?php echo home_url(); ?>" title="Link to Homepage"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lccc-culinary-logo.png" alt="Campana Center for Ideation and Invention of Lorain County Community College" class="logo" height="64" width="254" /></a>
